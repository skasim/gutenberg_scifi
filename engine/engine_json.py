...
filename = "gendered_words.json"


#### Create JSON Engine

def write_json(filename, test_dict):
    "writes json object"
    with open (filename, "w") as filename:
        data = json.dump(test_dict, filename)
...
def read_write_json_object(filename=None, key=None, value=None, READ=False, WRITE=False):
